...
A football-themed responsive website built with HTML5 and CSS3.

**Tech:** HTML5 · CSS3 · Poppins · Font Awesome

🔗 [Live Demo](https://takianova.github.io/responsive-football-repo/)  
📂 [View Repository](https://github.com/TakiaNova/responsive-football-repo)

### 💻 Developer Portfolio Website
A frontend portfolio practice project built with HTML5 and CSS3, featuring profile, skills, education, experience, and contact sections.

**Tech:** HTML5 · CSS3 · Open Sans
